...
public class Book {
    ...
    public int hashCode() {
        ...
        hash = 13 * hash + Objects.hashCode(this.imageFileName);
        hash = 13 * hash + Objects.hashCode(this.link);
        hash = 13 * hash + Objects.hashCode(this.published);
        return hash;
    }
