...
public class pollAnalysisWithException {
    ...
    public static void main(String[] args) {
       ...
       int[] pollResults = returnPollAnalysisArray(generatepollArray(20));
        ...
        for (int pollResult : generatepollArray(20)) {
